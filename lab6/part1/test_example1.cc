...
*/
TEST(NEW_FUNCTION, REVERSE_STRING) {
    const char* test_string_1 = "hello";
    const char* test_string_2 = "world";
    const char* test_string_3 = "a";
    const char* test_string_4 = "abb";
    char* reverse_1 = ReverseString(test_string_1);
    char* reverse_2 = ReverseString(test_string_2);
    char* reverse_3 = ReverseString(test_string_3);
    char* reverse_4 = ReverseString(test_string_4);
    EXPECT_EQ(strcmp(reverse_1, "olleh"), 0);
    EXPECT_EQ(strcmp(reverse_2, "dlrow"), 0);
    EXPECT_EQ(strcmp(reverse_3, "a"), 0);
    EXPECT_EQ(strcmp(reverse_4, "bba"), 0);
    free(reverse_1);
    free(reverse_2);
    free(reverse_3);
    free(reverse_4);
